...
<?php include_once('vistas/head.php'); ?>
  <body>
    <div class="container">
      ...
      <div class="jumbotron">
        <a class="btn btn-default" href="local.php">Regresar</a>
        ...
        <div class="form-horizontal">
          ...
          <br><br>
        <form class="form-horizontal" action="json/generar_archivo.php" method="POST" id="save_file">
